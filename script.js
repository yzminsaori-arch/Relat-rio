document.addEventListener("DOMContentLoaded", () => {
    ...
    const btnRegisterLink = document.getElementById('btn-register-link');
    const btnBackLoginReg = document.getElementById('btn-back-login-reg');
    ...
    let likesData = JSON.parse(localStorage.getItem('elite_likes_data')) || {};
    ...
    forgotForm.addEventListener('submit', (e) => {
        ...
        if (cleanCpf === '11122233344') {
            messageEl.style.color = 'var(--color-success)';
            messageEl.textContent = 'Usuário localizado. Sua senha é: 09072223';
        } else if (cleanCpf === '99988877766') {
            messageEl.style.color = 'var(--color-success)';
            messageEl.textContent = 'Usuário localizado. Sua senha é: 1234567';
        } else {
